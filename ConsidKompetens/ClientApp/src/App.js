  ...
  return (
    <div>
      ...
      <Switch>
        ...
        <Route path="/login" component={() => <LoginPage succeeded={this.loginSucceeded} failed={this.loginFailed} loggedIn={loggedIn}/>}/>
        <Route path="/register" component={() => <RegisterPage/>}/>
        <Route path="/user" component={() => <UserPage user={this.getUser()}/>}/>
